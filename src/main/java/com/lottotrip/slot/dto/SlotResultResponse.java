 ...
 *
 * <p>⚠️ <b>응답 스키마는 아직 확정이 아니다</b>(미확정 항목 5-10). ERD의 예시는
 * {@code place: { placeId, name }}뿐인데 이는 결정 10 이전의 것이다. 실시간 조회로 받아온 값
 * (설명·이미지·요금·무장애 정보) 중 무엇을 실을지 <b>프론트와 상의해 정하기로 했다.</b>
 * 지금은 {@link PlaceDetail}이 담는 소개글·홈페이지까지 내보낸다.
 *
 * @param place   장소 정보. DB에 담아 둔 값 + TourAPI 실시간 조회 결과가 섞여 있다
 * @param mission 이 장소의 미션. <b>없을 수 있다</b>
 */
