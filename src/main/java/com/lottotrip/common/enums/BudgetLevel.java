...
/**
 * 예산 등급. ERD의 `budget_level` enum에 대응한다.
 *
 * ⚠️ 경계 금액은 잠정값이다. ERD에 값 목록도 기준 금액도 없어 우선 정의했다.
 *
...
public enum BudgetLevel {
     ...
     * 금액을 등급으로 바꾼다.
     *
     * 선언 순서대로 훑으면서 "금액이 상한 이하인 첫 등급"을 고른다.
     * `HIGH`의 상한이 int 최댓값이라 어떤 금액이든 반드시 하나는 걸린다.
     */
